 ...
 */
static void tw686x_dma_delay(unsigned long timerAddr)
{
    struct timer_list *t = (struct timer_list *) timerAddr;
			...
			const struct pci_device_id *pci_id)
{
	...
	dev->dma_delay_timer.data = (unsigned long) &dev->dma_delay_timer;
	dev->dma_delay_timer.function = tw686x_dma_delay;
